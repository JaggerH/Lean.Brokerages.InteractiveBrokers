...
{
    /// <summary>
    /// Event arguments class for the <see cref="InteractiveBrokersClient.UpdateAccountTime"/> event
    /// </summary>
    public sealed class UpdateAccountTimeEventArgs : EventArgs
    {
        /// <summary>
        /// The time IB stamped on this account-update batch, as sent on the wire (HH:mm, TWS local time).
        /// </summary>
